...
Then [eza](https://github.com/eza-community/eza), [bat](https://github.com/sharkdp/bat), [tldr](https://github.com/tldr-pages/tldr) via *brew*, [fd-find](https://github.com/sharkdp/fd), [btop](https://github.com/aristocratos/btop), [thefuck](https://github.com/nvbn/thefuck). Apply setup:
